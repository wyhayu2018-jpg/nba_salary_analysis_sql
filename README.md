...
This project was built to demonstrate applied data strategy and financial analysis skills — specifically the ability to query relational datasets, identify trends, and surface actionable insights from raw data. These are directly transferable to corporate finance and data reporting environments where consolidating and interpreting large datasets is a core responsibility.
